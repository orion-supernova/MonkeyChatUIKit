...
//        view.addSubview(searchBar)
        ...
        usersTableView.addEmptyDataView(text: "You have no requests at the moment!", buttonText: nil)
    }
...
extension FriendRequestsViewController: UITableViewDelegate {
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        AlertHelper.alertMessage(viewController: self, title: "Friend Approvel", message: "Do you want to approve the request?", okButtonText: "Yeap") {
            //
        }
